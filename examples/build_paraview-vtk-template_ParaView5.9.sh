#!/bin/bash
#
# Usage: build_paraview-vtk-template_ParaView5.9.sh [ -egl | -osmesa ]
#

set -e

readonly paraview_version="5.9.1$1"
...
docker exec ${container} /usr/bin/scl enable devtoolset-8 -- cmake \
  ...
  -DCMAKE_INSTALL_PREFIX=/tmp/install/ParaView-${paraview_version}-MPI-Linux-Python3.8-64bit 
